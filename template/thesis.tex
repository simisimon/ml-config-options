...
\subsection{Web Scraping der ML-Klassen}\label{scrape}
...
\subsection{Extraktion der ML-Klassen}\label{Classes}
...
\subsection{Extraktion und Verarbeitung der Konfigurationsoptionen} \label{Parameters}
...
Die Ermittlung der variablen Parameterewerte erfolgt über die Methode \textit{get\_parameter\_value()} der \textit{DataFlowAnalysis}-Klasse.
Beim Aufruf der Methode wird das Dictionary zusammen mit der Parametervariable übergeben.\\
...
Befindet sich das Objekt innerhalb des Funktionsraums, endet die Suche an dieser Stelle.
...
Wird bei einem Iterationsvorgang eine Zuweisung gefunden, die die gesuchte Parametervariable zum Ziel hat, wird sie in der
...
Falls kein möglicher Variablenwert gefunden wurde, werden die Parameter in der Definition der Funktion überprüft.
Ist die Parametervariable in der Definition vorhanden, müssen einige Besonderheiten berücksichtigt werden.
Die Parameter einer Funktion können fünf unterschiedliche AST-Typen besitzen: \textit{arg}, \textit{vararg}, \textit{kwonlyargs},
\textit{Pos} oder \textit{kwarg}.
...
\begin{lstlisting}[language=Python, frame=single, basicstyle=\small]
def func(posonlyarg1, posonlyarg2=1, /, arg1=2, arg2=3,
         arg3=4, *vararg, kwonlyarg1, kwonlyarg2=6, **kwarg):
    return

func(0, 1, arg2=3, *[2], kwonlyarg1=5, kwonlyarg2=6,
     **{"arg3": 4, "new_arg": 7})
\end{lstlisting}
\
