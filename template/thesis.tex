...
Da die Lösung dieses Problems essenziell für unsere Datenflussanalyse ist, haben wir den Source Code der \textit{compute\_SSA()}-Methode
...
Jeder Funktionsaufruf wird mit den möglichen Werten aus der Liste an Dicitonaries mit möglichen Aufrufspfaden verglichen und
...
Im folgendem Kapitel wird das soeben beschriebene Tool evaluiert.
Da die Verwendung von Konfigurationsoptionen von ML-Bibliotheken im Source nicht umfassend erforscht ist, gibt es keine
Datensätze oder Vergleichswerte, um die Genauigkeit des Algoritmhus bewerten zu können.
Um dennoch eine aussagekräftige Bewertung abgeben zu können, wird sich am Evaluationsansatz von \citeauthor{10.1145/1985793.1985812}
orientiert.
Dafür werden verschiedene Softwareprojekte mit unserem Ansatz analysiert und das Ergebnis mit einer manuellen Analyse verglichen.
...
Die Auswahl an Softwareprojekten erfolgt nach folgenden Kriterien:
\begin{itemize}
 \item Open Source Git Repository mit mindestens 200 Sternen
 \item Verwendung von mindestens 25-100 Klassen einer ML-Bibliothek
