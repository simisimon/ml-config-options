...
\noindent\begin{minipage}{\linewidth}
\begin{lstlisting}[language=Python, frame=single, label=gbccode, basicstyle=\small, caption={Nutzung einer scikit-learn Klasse},captionpos=b]
...
Das Ergebnis wird in der Tabelle \ref{manuell} zusammengefasst.
Die Tabelle \ref{eval} gibt für jedes der fünfzehn Softwareprojekte die Anzahl der gefundenen Klassen und Anzahl der
(variablen) Parameter an.
Darüber hinaus werden für die variablen Parameter in der letzten Spalten die Anzahl der möglichen Werte anhand
...
\begin{center}
\setlength{\tabcolsep}{5pt}
\begin{tabular}[h]{l|c|c|c|c|c|c|c|c} %p{7cm}
\hline
\multirow{3}{*}{ML-Projekt} & \multicolumn{2}{c|}{\multirow{2}{*}{Klassen}}  & \multicolumn{2}{c|}{\multirow{2}{*}{Parameter}}      &   \multicolumn{4}{c}{variable Parameter}\\
                            ...
                            & Anz.      & \%                & Anz.      & \%                    & Anz.      & \%    & Anz.          & \% \\
\hline \hline
DeepSpeech                  & 34        & 100\%             & 47        & 100\%                 & 24        & 100\% & 30            & 97\%\\
