...
Im nächsten Schritt werden die Klassen der jeweiligen ML-Bibliothek aus dem Source Code extrahiert.
...
Zunächst muss dafür der Python-Code über die \textit{ast}-Bibliothek in das AST-Format umgewandelt werden.
Die Traversierung des Syntax-Baumes erfolgt stets nach dem Preoder-Verfahren, sodass jeder Knoten eines Teilbaums vollständig
