...
Betrachten wir das folgende Codebeispiel in die scikit-learn Klasse \textit{LogisticRegression} initialisiert wird.
...
Da keine Parameter angegben werden, wird die Klasse mit den Default-Werten initialisiert, zum Beispiel
\textit{max\_iter = 100, verbose = 0, n\_jobs = 1}.
In der Version \textit{scikit-learn 0.21.3} wird für den Parameter \textit{multi\_class} als Default, noch der Wert \textit{ovr} ausgegeben.
\\
