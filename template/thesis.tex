...
Im \textit{???}-Ordner des Git-Repositorys befinden sich mehrere Codebeispiele mit Konfigurationsoptionen, die aus
verschiedenen Softwareprojekten entnommen wurden.
...
\begin{itemize}
 ...
 \item Verwendung mindestens zehn Klassen einer ML-Bibliothek
 \item möglichst Verwendung von variablen Parametern beim Aufruf der Klassen
 \item Code ist syntaktisch fehlerfrei
\end{itemize}

Ein Stern für ein Repository dient sowohl als Lesezeichen als auch als Zeichen der Wertschätzung für das Projekt.
Aus der Anzahl an Sternen kann man daher Aussagen über die Qualität eines Projektes ableiten
Die Anzahl der Sterne eignet sich daher als Auswahlkriterium, um eine repräsentative Liste an Softwareprojekten, die die
...
Für jede der vier ML-Bibliotheken werden jeweils fünf Softwareprojekte untersucht.
...
Die zweite Ursache ist die Verarbeitung mehhhhhhrerer Zuweisungen an die gleiche Variable innerhalb eines Funktionskörpers.
